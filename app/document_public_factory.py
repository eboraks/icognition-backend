...
from app.models import DocumentPublic, EntityPublic, Chat_Message, EventName
...
def chat_messages_to_document_public(chat_messages: List[Chat_Message], document: DocumentPublic) -> DocumentPublic:
    """
    ...
    # Initialize DocumentPublic with chat_id as the unique ID
