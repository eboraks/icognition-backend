...
from app.models import Document, Embedding, Entity
...
class EmbeddingHandler:
    ...
    def _find_documents_without_embeddings(self, user_id: str):
        with Session(engine) as session:
            # Find documents that belong to this user and have content
            ...
            # Get existing embedding IDs for this user
            embeddings_ids = session.scalars(
