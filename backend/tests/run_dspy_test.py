#!/usr/bin/env python3
"""
CLI script to run DSPy content extraction tests
"""
...
from tests.test_dspy_extraction import DSPyExtractionTest
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Test DSPy content extraction on existing documents",
...
Examples:
  ...
  python run_dspy_test.py --ids 25
    ...
    try:
        ...
        print(f"\nDetailed results saved to: tests/data/dspy_extraction_results_{test.timestamp}.json")
